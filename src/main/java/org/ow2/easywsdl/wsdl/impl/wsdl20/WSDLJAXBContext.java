...
public final class WSDLJAXBContext {
    ...
    private static final Class<?>[] WSDL20_DEFAULT_OBJECT_FACTORIES = new Class<?>[] {
    ...
    static {
    	try {
            SchemaJAXBContext.getInstance().addOtherObjectFactory(WSDL20_DEFAULT_OBJECT_FACTORIES);
    ...
    public static Class<?>[] getDefaultObjectFactories() {
        return WSDL20_DEFAULT_OBJECT_FACTORIES.clone();
    }
